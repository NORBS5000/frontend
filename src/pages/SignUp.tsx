    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-teal-50 p-4 relative overflow-hidden">
        <div className="absolute top-0 right-0 -z-10 opacity-30">
          <div className="w-[600px] h-[600px] bg-gradient-to-br from-green-400 via-emerald-400 to-teal-400 rounded-full blur-3xl animate-float"></div>
        </div>
        ...
        <div className="max-w-lg w-full glass rounded-3xl shadow-2xl border border-white/30 p-10 text-center animate-scale-in">
          ...
          <div className="mt-8">
            <div className="w-full bg-gray-200 rounded-full h-3 shadow-inner-soft">
              <div className="bg-gradient-to-r from-green-500 to-emerald-600 h-3 rounded-full animate-pulse shadow-glow"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-teal-50 p-4 relative overflow-hidden">
      ...
      <div className="max-w-lg w-full glass rounded-3xl shadow-2xl border border-white/30 p-10 animate-scale-in">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-700 text-lg font-medium">Join MediLoan for healthcare financial support</p>
        </div>
