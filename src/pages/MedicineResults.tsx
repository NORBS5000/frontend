    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
          ...
          <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">Based on your uploaded documents, here are the identified medicines:</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="bg-blue-50 rounded-lg p-4">
              <div className="flex items-center mb-2">
                ...
                <span className="font-semibold text-blue-900">Medicament Analysis</span>
              </div>
            ...
            <div className="bg-green-50 rounded-lg p-4">
              <div className="flex items-center mb-2">
                ...
                <span className="font-semibold text-green-900">Prescription Analysis</span>
              </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            {medicines.length > 0 ? (
                ...
                <div key={medicine.id} className="border border-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-md transition-shadow">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm sm:text-base text-gray-600 mb-2">{medicine.description}</p>
              ...
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No medicines identified</h3>
                <p className="text-gray-500">The analysis couldn't identify any medicines from the uploaded images.</p>
              </div>
            )}
          </div>
          ...
          {medicines.length > 0 && medicines.some(m => m.price) && (
            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-0">
                <span className="text-lg sm:text-xl font-semibold text-gray-900">Estimated Total Cost:</span>
